...
/* The user-id will be = First Letter of the smaller name + Entire word in the longer name 
 * + Digit at position N in the PIN when traversing the PIN from left to right
 *  + Digit at position N in the PIN when traversing the PIN from right to left
 */
